...
public class ExampleTest {
    ...
    홀수입니다
    * */
    public void even0dd(int value){
        System.out.println(value%2==1?"홀수":"짝수");
    }
    ...
    * */
    public void randomMathQuiz(){
        ...
        int num = sc.nextInt();
        System.out.println(num==num1+num2?"정답입니다!":"틀렸습니다 정답은"+(num1+num2)+"입니다.");
    }
